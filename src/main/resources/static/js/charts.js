...
var handleDonutChart2 = function() {
	"use strict";
	if ($("#donut-chart_2").length !== 0) {
		var e = [];
		var t = 3;
		var n = [dark, green, purple];
		var r = ["", "Rate"];
...
var handleDonutChart4 = function() {
	"use strict";
	if ($("#donut-chart4").length !== 0) {
		var e = [];
		var t = 3;
		var n = [dark, green, purple];
		var r = ["", "Rate"];
...
var handleDonutChart3 = function() {
	"use strict";
